    ...
    <div class="auth-card">
      ...
      <div class="form-panel">
        <div class="form-header">
          <h1>Create an analyst staff account</h1>
        ...
        <form class="form">
          <div class="field-row">
            <label>
              First name
              <input type="text" placeholder="Fletcher" />
            </label>
            <label>
              Last name
              <input type="text" placeholder="Reed" />
            </label>
          </div>
          <label>
            Work email
            <input type="email" placeholder="analyst@bookstore.com" />
          </label>
          <label>
            Password
